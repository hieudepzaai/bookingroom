...
@section("content")
    ...
    <!--filter-->
    <div class="section w-100 mx-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form class="show  filter-container " id="collapseExample">

                        <div class="mx-1">
                            <span class="fw-bold">City</span>
                            <select class="js-example-placeholder-single  form-control" name="dat">
                                <option></option>
